    ...
    for (var i = 0; i < items.length; i++) {
        ...
        tabla += `<tr>
                  <td>${items[i].category.name}</td>
                   ...
                   <td><button class="botonEditar" onclick="editarRegistro(${items[i].id})">Editar</button></td>
                   <td><button class="botonBorrar" onclick="mostrarEliminar(${items[i].id},'${texto}')">Borrar</button></td>
                   </tr>`;
    }
