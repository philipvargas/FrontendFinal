...
function listar() {
    $.ajax({
        ...
        url: "http://129.151.125.65:8081/api/Reservation/all",
    ...
    for (var i = 0; i < items.length; i++) {
        ...
        */
        ...
        tabla += `<tr>
                   ...
                   <td><button class="botonEditar" onclick=editarRegistro(${items[i].idReservation})>Editar</button></td>
                   <td><button class="botonBorrar" onclick="mostrarEliminar(${items[i].idReservation},'${texto}')">Borrar</button></td>
